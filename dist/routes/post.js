...
router.get("/get_all_todos", auth_1.default, blogController_1.getPost);
router.get("/get_single_todos/:id", auth_1.default, blogController_1.singlePost);
router.get("/get_all_todos/:userId", auth_1.default, blogController_1.getUserPost);
router.delete("/delete_single_todo/:id", auth_1.default, blogController_1.deleteSinglePost);
